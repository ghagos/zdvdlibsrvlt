...
public class ListLibraryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            dvdList.add(new DvdItem("Star Wars Episode I", "1999", "Sci-Fi"));
            dvdList.add(new DvdItem("Close Encounters of the Third Kind", "1977", "Sci-Fi"));
            dvdList.add(new DvdItem("Star Trek 3: The Search for Spock", "1984", "Sci-Fi"));
